...
import { Navbar, NavbarBrand, Nav, NavbarToggler, Collapse, NavItem, Jumbotron, Modal, Button, ModalHeader, ModalBody, FormGroup, Input, Form, Label } from 'reactstrap';
...
class Header extends Component {
    ...
    handleLogin(event){
        this.toggleModal();
        alert("Username: "+this.username.value + " Password: "+this.password.value+" Rem: "+this.remember.checked);
            ...
            <React.Fragment>
                <Navbar dark expand="md">
                    ...
                    <NavbarBrand className="mr-auto" href="/">
                        <img src="/assets/images/logo.png" height="30" width="41" alt="East of West Restaurant"/>
                    </NavbarBrand>
